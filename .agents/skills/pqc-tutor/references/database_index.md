...
Quick-reference map for which database file to consult for each question type.
Full inventory at `database/index.json`.
...
| Prompt templates | `.claude/skills/pqc-tutor/resources/prompt_templates.md` |
